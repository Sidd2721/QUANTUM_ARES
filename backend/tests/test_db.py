...
def test_create_and_get_scan():
    ...
    from app.db.database import init_schema, get_db
    from app.db.repository import create_scan, get_scan, update_scan_running
...
def test_cross_org_isolation():
    ...
    from app.db.database import init_schema, get_db
    from app.db.repository import create_scan, get_scan
    ...
    result = get_scan(scan_id, 'orgB')  # should return None â€” not visible to orgB
...
def test_update_scan_result_atomic():
    ...
    from app.db.database import init_schema, get_db
    from app.db.repository import create_scan, update_scan_result, get_scan
